...
[`models/prd_model_manifest.json`](models/prd_model_manifest.json). Notebooks
are the primary training and evaluation workflow; technical metadata is
...
Trained models are persisted under `models/`. Historical experiment artifacts
in `models/genome_experiment_v1/` remain immutable.
